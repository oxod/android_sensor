...
import com.android.server.temperature.JdtsService;
...
class ServerThread {
    ...
    public void initAndLoop() {
        ...
        if (factoryTest != SystemServer.FACTORY_TEST_LOW_LEVEL) {
            ...
            // ******************** ADDED BY TECHARTMS_JDTS ***************************
            try {
                Slog.e(TAG, "Jdts Service");
                jdtsService = new JdtsService(context);
                ServiceManager.addService(Context.JDTS_TEMPERATURE_SERVICE, jdtsService);
            } catch (Throwable e) {
                Slog.e(TAG, "Failure starting JdtsService", e);
            }
            // ******************** ADDED BY TECHARTMS_JDTS ***************************
